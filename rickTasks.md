...
- Explain why MeeSeeks _(the blue character on top)_ appears below the header and not above in the Z direction
- MeeSeeks disappears when the user clicks on them. Animate his exit so that he gradually shrinks instead of suddenly disappearing, and the content below him should gradually rise as well. <br/>
  Example: <br/>
